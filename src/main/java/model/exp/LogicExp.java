	...
	public Value eval(MyIDictionary<String,Value> tbl,MyIHeap hp) throws VarNotDefined, DivByZero, CustomException {
		 ...
		 if (v1.getType().equals(new BoolType())) {
			 ...
			 if (v2.getType().equals(new BoolType())) {
				 ...
				 n1= i1.getVal();
				 n2 = i2.getVal();
				 if (op==1) return new BoolValue(n1 && n2,i1.getTaint() || i2.getTaint(),Security_Class.PUBLIC);
				 if (op ==2) return new BoolValue(n1||n2,i1.getTaint() || i2.getTaint(),Security_Class.PUBLIC);
